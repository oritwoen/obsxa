...
**Version:** 0.2.1 (Feb 2026)
**Tags:** latest: 0.2.1 (Feb 2026)
...
```bash
skilld search "query" -p citty
skilld search "issues:error handling" -p citty
skilld search "releases:deprecated" -p citty
```
